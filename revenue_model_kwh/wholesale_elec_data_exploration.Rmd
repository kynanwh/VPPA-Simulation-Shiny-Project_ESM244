...
write.csv(caiso_day_complete, "caiso_2015-2018_daily.csv")


#### Test for Shiny

caiso_day_complete2 <- read_csv("caiso_2015-2018_daily.csv")

caiso_day_complete2$Date <- as.Date(caiso_day_complete2$Date,
                                         format="%m/%d/%Y")
