...
write.csv(caiso_single, "caiso_single.csv")
...
caiso_4yr <- read_csv("caiso_2015-2018.csv")
...
```{r decompose hourly data message = FALSE}
...
renew_prod_final <- rbind(solar1, solar2, solar3)
